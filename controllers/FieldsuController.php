...
/**
 * FieldsuController implements the CRUD actions for Options model.
 */
class FieldsuController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionIndex()
    {
        ...
        $dataProvider = $searchModel->fieldsusearch(Yii::$app->request->queryParams);
